...
export default function InboundCreate() {
    ...
    const handleCreateInbound = (event) => {
        ...
        formsData.append('stuff_id', forms.stuff_id);
        formsData.append('total', forms.total);
        formsData.append('date', forms.date);
        formsData.append('proff_file', document.getElementById('proff_file').files[0]); // Mengambil file pertama
    
        instance.post('inbound/create', formsData, {
            headers: {
